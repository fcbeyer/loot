 ...
 */
public class GoalDetailActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(GoalDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(GoalDetailFragment.ARG_ITEM_ID));
